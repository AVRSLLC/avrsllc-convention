...
> Папка `Framework` не предназначена для хранения контентной части проекта, и потому недопустим вносить в нее какие либо изменения без конкретной цели или поставленной задачи.
...
### 2.3 Менеджмент Level и Level Instance[<sup>*</sup>](#terms-level-map)
